...
| -- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1  | **-** | Create the environment grid (walls, traps, goal, adjustable size). Develop the main loop for all algorithms. Work on MCTS, Alpha-Beta, and Minimax. Handle final integration and testing. |
| 2  | **-**        | Develop the main loop for all algorithms. Implement the **MCTS** algorithm. Integrate the implemented algorithm into the main system.                                                     |
| 3  | **-**         | Develop parts of **MCTS** (tree structure and simulation). Integrate the implemented algorithm into the main system.                                                                      |
| 4  | **-**        | Implement the **Alpha-Beta Pruning** and **Minimax** algorithm. Integrate the implemented algorithm into the main system.                                                                                 |
| 5  | **-**        | Implement the **Alpha-Beta Pruning** and **Minimax** algorithm. Integrate the implemented algorithm into the main system.                                                                                            |
